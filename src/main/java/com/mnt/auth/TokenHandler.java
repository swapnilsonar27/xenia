...
public final class TokenHandler {
    ...
    public static String getRoles(String token) {
        ...
        .parseClaimsJws(token)
        .getBody();
    	if(claims == null || claims.get("roles") == null) return "";
    ...
    public static String createTokenForUserEvent(String user, String event) {
    	Map<String, Object> map = new HashMap<>();
    	//map.put("roles", user.getAuthorities().toString());
    	//map.put("permissions",((AuthUser)user.getPrincipal()).getPermissions().toString());
	...
	public static String getPermissions(String token) {
		...
		if(claims == null || claims.get("permissions") == null) return "";
